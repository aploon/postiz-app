...
import {
  ...
  Sections,
} from '@gitroom/takka-backend/services/auth/permissions/permission.exception.class';
import { PostValidationException } from '@gitroom/takka-backend/api/routes/posts.validation.exception';
