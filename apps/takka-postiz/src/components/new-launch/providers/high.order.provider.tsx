...
import { InternalChannels } from '@gitroom/takka-postiz/components/launches/internal.channels';
...
export { PostComment } from '@gitroom/takka-postiz/components/new-launch/providers/post-comment.enum';
import { PostComment } from '@gitroom/takka-postiz/components/new-launch/providers/post-comment.enum';
