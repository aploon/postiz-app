...
import { MediaComponentInner } from '@gitroom/takka-postiz/components/launches/helpers/media.settings.component';
...
const Polonto = dynamic(
  () => import('@gitroom/takka-postiz/components/launches/polonto')
);
