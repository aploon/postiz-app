...
import { StarsAndForks } from '@gitroom/takka-postiz/components/analytics/stars.and.forks';
import { FC, useCallback } from 'react';
import { StarsTableComponent } from '@gitroom/takka-postiz/components/analytics/stars.table.component';
