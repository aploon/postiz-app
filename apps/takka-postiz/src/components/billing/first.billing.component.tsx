...
import { LogoTextComponent } from '@gitroom/takka-postiz/components/ui/logo-text.component';
import { pricing } from '@gitroom/nestjs-libraries/database/prisma/subscriptions/pricing';
import { capitalize } from 'lodash';
import clsx from 'clsx';
import { LoadingComponent } from '@gitroom/takka-postiz/components/layout/loading';
import { CheckIconComponent } from '@gitroom/takka-postiz/components/ui/check.icon.component';
import {
  FAQComponent,
  FAQSection,
} from '@gitroom/takka-postiz/components/billing/faq.component';
import { useT } from '@gitroom/react/translation/get.transation.service.client';
import { useUser } from '@gitroom/takka-postiz/components/layout/user.context';
import { useDubClickId } from '@gitroom/takka-postiz/components/layout/dubAnalytics';
...
import { DeveloperIconComponent } from '@gitroom/takka-postiz/components/developer/developer.icon.component';
...
const EmbeddedBilling = dynamic(
  () =>
    import('@gitroom/takka-postiz/components/billing/embedded.billing').then(
