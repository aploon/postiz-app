...
import { setCookie } from '@gitroom/takka-postiz/components/layout/layout.context';
import { useT } from '@gitroom/react/translation/get.transation.service.client';
import { useModals } from '@gitroom/takka-postiz/components/layout/new-modal';
import { Button } from '@gitroom/react/form/button';
import { ImportDebugPostModal } from '@gitroom/takka-postiz/components/launches/import-debug-post.modal';
...
export const Impersonate = () => {
  ...
  return (
    <div>
      <div className="bg-forth min-h-[52px] px-[8px] flex justify-center items-center border-input border rounded-[8px] text-white">
