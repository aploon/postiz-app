...
import { AddProviderButton } from '@gitroom/takka-postiz/components/launches/add.provider.component';
import { FC, useCallback, useEffect, useMemo, useState } from 'react';
import SafeImage from '@gitroom/react/helpers/safe.image';
import { capitalize, groupBy, orderBy } from 'lodash';
import { CalendarWeekProvider } from '@gitroom/takka-postiz/components/launches/calendar.context';
import { Filters } from '@gitroom/takka-postiz/components/launches/filters';
import { useFetch } from '@gitroom/helpers/utils/custom.fetch';
import { LoadingComponent } from '@gitroom/takka-postiz/components/layout/loading';
import clsx from 'clsx';
import { useUser } from '../layout/user.context';
import { Menu } from '@gitroom/takka-postiz/components/launches/menu/menu';
...
import { DNDProvider } from '@gitroom/takka-postiz/components/launches/helpers/dnd.provider';
import { useVariables } from '@gitroom/react/helpers/variable.context';
import { NewPost } from '@gitroom/takka-postiz/components/launches/new.post';
import { useT } from '@gitroom/react/translation/get.transation.service.client';
import { useIntegrationList } from '@gitroom/takka-postiz/components/launches/helpers/use.integration.list';
import useCookie from 'react-use-cookie';
import { Onboarding } from '@gitroom/takka-postiz/components/onboarding/onboarding';
    ...
    <DNDProvider>
      ...
      <CalendarWeekProvider integrations={sortedIntegrations}>
        ...
        >
          <div
            className={clsx(
              'bg-newBgColorInner p-[20px] flex flex-col gap-[15px] transition-all w-full max-h-[40vh] lg:max-h-none lg:absolute lg:start-0 lg:top-0 lg:h-full overflow-x-hidden overflow-y-auto scrollbar scrollbar-thumb-fifth scrollbar-track-newBgColor'
            )}
          >
        ...
        <div className="bg-newBgColorInner flex-1 min-w-0 min-h-[80vh] lg:min-h-0 flex-col flex p-[12px] lg:p-[20px] gap-[12px]">
          <Filters />
