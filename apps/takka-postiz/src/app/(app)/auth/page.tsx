...
import { Register } from '@gitroom/takka-postiz/components/auth/register';
import { Metadata } from 'next';
import Link from 'next/link';
import { getT } from '@gitroom/react/translation/get.translation.service.backend';
import { LoginWithOidc } from '@gitroom/takka-postiz/components/auth/login.with.oidc';
export const metadata: Metadata = {
  title: `Takka Register`,
  description: '',
};
